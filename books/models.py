...
class Book(models.Model):
    ...
    instock_qty = models.PositiveSmallIntegerField('InStock Qty', default=0)
    rented_out_qty = models.PositiveSmallIntegerField('Rented Out Qty', default=0)
    lost_qty = models.PositiveSmallIntegerField('Lost Qty', default=0)
